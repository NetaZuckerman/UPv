...
if __name__ == "__main__":
    ...
    reference, fastq, threads, flu_flag, de_novo_flag, polio_flag, cmv_flag, hiv_flag, \
        sensitive_hiv, hsv_flag, minion_flag, gb_file, regions_file, mutations_flag, annotation_db, mini, \
    ...
    dirs=['BAM','QC','CNS','CNS_' + cns_min_depth_call ,'QC/depth', 'alignment'] 
    ...
    if mutations_flag or mini and not cmv_flag:
        ...
        signatures.run("alignment/all_aligned.fasta", regions_file, "reports/mutations.xlsx", annotation_db=annotation_db)
