...
de novo analysis is good for cases where you dont know the virus youre looking for,
or when you dont have a reference for the virus.
...
class de_novo(general_pipe):
    ...
    def __init__(self, reference, fastq, minion, threads, virus_name):
        ...
        virus_name : str
            virus name to prefare if exist.

        Raises
        ------
        ValueError
            de-novo pipeline only works with illumina reads.
    ...
    def run_spades(self):
        '''
        run spades on paired end fastq files to get contigs. 
    ...
    def run_blast(self):
        '''
        run blast on the contigs generated by run_spades()
    ...
    def choose_reference_filter_contigs(self):
        ...
        filter contigs that blast found results for, save the contigs in selected_contigs folder for later mapping.
        
        Returns
        -------
        sample_ref : pandas.Dataframe
            table of the chosen refernce details for each sample.
    ...
    def import_references(self):
        '''
        import references that were chosen by choose_reference_filter_contigs().
    ...
    def mapping(self):
        ...
        run class private functions before mapping.
        2 mapping processes:
            1- map raw fastq reads to selected reference. output in bam_path/fastq_based.
            2- map selected contigs to selected reference. output in bam_path/contig_based.
        Returns
        -------
        None.
